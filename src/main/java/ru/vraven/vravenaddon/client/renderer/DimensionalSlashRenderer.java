...
public class DimensionalSlashRenderer extends EntityRenderer<DimensionalSlash> {
    ...
    @Override
    public void render(DimensionalSlash entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
        poseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(DimensionalSlash entity) {
        return TEXTURE;
    }
}