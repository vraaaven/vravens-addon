...
import ru.vraven.vravenaddon.client.model.DarkDaggerModel;
import software.bernie.geckolib.animatable.GeoAnimatable;
import software.bernie.geckolib.cache.object.BakedGeoModel;
import software.bernie.geckolib.renderer.GeoEntityRenderer;
import software.bernie.geckolib.util.Color;

public class DarkDaggerRenderer<T extends FieryDaggerEntity & GeoAnimatable> extends GeoEntityRenderer<T> {
    public DarkDaggerRenderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new DarkDaggerModel<>());
    }
