...
public class FieryDaggerMagicProjectile extends FieryDaggerEntity {
    ...
    public FieryDaggerMagicProjectile(Level level) {
        this(EntityRegistry.FIERY_DAGGER_MAGIC_PROJECTILE.get(), level);
    }
    ...
    protected void onHitEntity(EntityHitResult entityHitResult) {
        ...
        var spell = SpellRegistry.getSpell(ResourceLocation.fromNamespaceAndPath(VravenAddon.MOD_ID, "fiery_dagger"));
    ...
    public void trailParticles() {
        ...
        for (int j = 0; j < steps; ++j) {
            ...
            this.level().addParticle(ParticleHelper.EMBERS, x, y, z, 0, 0, 0);
        }
    }
    ...
    protected void addAdditionalSaveData(CompoundTag tag) {
        ...
        if (this.ownerTrack != null) tag.put("ownerTrack", NBT.writeVec3Pos(this.ownerTrack));
        tag.putInt("Age", this.age);
        if (this.launchDir != null) tag.put("launchDir", NBT.writeVec3Pos(this.launchDir));
    }
    ...
    protected void readAdditionalSaveData(CompoundTag tag) {
        ...
        if (tag.contains("ownerTrack")) this.ownerTrack = NBT.readVec3(tag.getCompound("ownerTrack"));
        this.age = tag.getInt("Age");
        if (tag.contains("launchDir")) this.launchDir = NBT.readVec3(tag.getCompound("launchDir"));
    }
