...
import ru.vraven.vravenaddon.entity.spells.DarkBreathProjectile;

import java.util.List;
import java.util.Optional;

public class DarkBreathSpell extends AbstractSpell {
    private final ResourceLocation spellId = ResourceLocation.fromNamespaceAndPath(VravenAddon.MOD_ID, "dark_breath");
    ...
    public void onCast(Level world, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        if (playerMagicData.isCasting() && playerMagicData.getCastingSpellId().equals(this.getSpellId())
            ...
            DarkBreathProjectile projectile = new DarkBreathProjectile(world, entity);
